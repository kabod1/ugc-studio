...
export async function updateSession(request: NextRequest) {
  ...
  const publicRoutes = ["/", "/login", "/signup", "/forgot-password", "/reset-password", "/offline", "/terms", "/privacy", "/cookie-policy", "/pricing", "/checkout", "/api/stripe/webhook", "/api/n8n/ugc-video-callback", "/api/subscriptions/manual-payment", "/api/payments/schedule-payouts", "/api/product-transform/status"]
