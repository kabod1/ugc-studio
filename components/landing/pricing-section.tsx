...
const businessTiers = {
  monthly: [
    {
      name: "Free",
      description: "Try UGC Studio at no cost",
      price: "$0",
      period: "",
      features: [
        "2 campaigns",
        "Up to 5 seats per campaign",
        "2 AI UGC videos per month",
    ...
    },
    {
      ...
      features: [
        ...
        "50 AI UGC videos per month",
        "5 AI Influencer slots",
        "Everything in Starter",
        "Analytics dashboard",
        "3 team seats · Priority support",
      ],
      recommended: true,
    },
    {
      name: "Scale",
      description: "Unlimited AI content for high-growth brands",
      price: "$243",
      period: "/month",
      features: [
        ...
        "20 Premium HD videos per month",
  ...
  annual: [
    ...
    },
    {
      ...
      price: "$12",
      period: "/month",
      savings: "Save $84 (37%) with annual billing",
      billedYearly: "Billed $144 per year",
      monthlyPrice: "$19",
      features: [
        "5 campaigns per month",
        "Up to 20 seats per campaign",
    ...
    },
    {
      ...
      price: "$55",
      period: "/month",
      savings: "Save $384 (37%) with annual billing",
      billedYearly: "Billed $660 per year",
      monthlyPrice: "$87",
      features: [
        "10 campaigns per month",
        "Up to 50 seats per campaign",
    ...
    },
    {
      ...
      price: "$153",
      period: "/month",
      savings: "Save $1,080 (37%) with annual billing",
      billedYearly: "Billed $1,836 per year",
      monthlyPrice: "$243",
      features: [
        "Unlimited campaigns & seats",
        "Unlimited AI UGC videos",
    ...
    <section id="pricing" className="py-20 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className={`grid grid-cols-1 gap-6 ${
          tiers.length === 4 ? "sm:grid-cols-2 lg:grid-cols-4" : tiers.length === 2 ? "md:grid-cols-2 max-w-3xl mx-auto" : "md:grid-cols-3"
        }`}>
          {tiers.map((tier) => (
            <div
              key={tier.name}
