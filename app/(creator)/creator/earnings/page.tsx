...
export default function EarningsPage() {
  ...
  async function setupConnect() {
    ...
    try {
      ...
      setConnectError(data.error || "Failed to set up Stripe Connect. Please try again.")
    } catch (err: any) {
    ...
    <div className="space-y-6">
      ...
      {!creator?.stripe_connect_account_id && (
        <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
          ...
          <p className="text-sm text-muted-foreground mb-4">Connect your Stripe account to receive payments directly to your bank.</p>
          {connectError && (
          ...
          <button onClick={setupConnect} disabled={settingUp}
            ...
            {settingUp ? "Setting up..." : "Set Up Stripe Connect"}
          </button>
        </div>
      )}
